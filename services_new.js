...
const SERVICES = {
                ...
                endpoints: [
                    {
                        method: 'GET',
                        path: '/applications',
                        description: 'Returns list of application objects',
                    ...
                    },
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/graph/api/application-get'
                    },
                    {
                        method: 'POST',
                        path: '/applications',
                        description: 'Create new application',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/application-post-applications'
                    },
                    {
                        method: 'PATCH',
                        path: '/applications/{id}',
                        description: 'Update application properties',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/application-update'
                    },
                    {
                        method: 'DELETE',
                        path: '/applications/{id}',
                        description: 'Delete application',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/application-delete'
                    },
                    {
                        method: 'POST',
                        path: '/applications/{id}/addPassword',
                        description: 'Add password credential',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/application-addpassword'
                    },
                    {
                        method: 'POST',
                        path: '/applications/{id}/removePassword',
                        description: 'Remove password credential',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/application-removepassword'
                    }
                ]
            },
            servicePrincipals: {
                ...
                endpoints: [
                    ...
                    },
                    {
                        ...
                        description: 'Get service principal by ID',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/serviceprincipal-get'
                    },
                    {
                        method: 'POST',
                        path: '/servicePrincipals',
                        description: 'Create service principal',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/serviceprincipal-post-serviceprincipals'
                    },
                    {
                        method: 'PATCH',
                        path: '/servicePrincipals/{id}',
                        description: 'Update service principal',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/serviceprincipal-update'
                    },
                    {
                        method: 'DELETE',
                        path: '/servicePrincipals/{id}',
                        description: 'Delete service principal',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/serviceprincipal-delete'
                    }
                ]
            },
            conditionalAccess: {
                ...
                endpoints: [
                    ...
                    },
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/graph/api/conditionalaccesspolicy-get'
                    },
                    {
                        method: 'POST',
                        path: '/identity/conditionalAccess/policies',
                        description: 'Create policy',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/conditionalaccessroot-post-policies'
                    },
                    {
                        method: 'PATCH',
                        path: '/identity/conditionalAccess/policies/{id}',
                        description: 'Update policy',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/conditionalaccesspolicy-update'
                    },
                    {
                        method: 'DELETE',
                        path: '/identity/conditionalAccess/policies/{id}',
                        description: 'Delete policy',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/conditionalaccesspolicy-delete'
                    }
                ]
            },
            directoryRoles: {
                ...
                endpoints: [
                    ...
                    },
                    {
                        ...
                        description: 'Get directory role',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/directoryrole-get'
                    },
                    {
                        method: 'GET',
                        path: '/directoryRoles/{id}/members',
                        description: 'List role members',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/directoryrole-list-members'
                    },
                    {
                        method: 'POST',
                        path: '/directoryRoles/{id}/members/$ref',
                        description: 'Add member to role',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/directoryrole-post-members'
                    }
                ]
            },
                ...
                endpoints: [
                    {
                        ...
                        description: 'List app role assignments',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/serviceprincipal-list-approleassignedto'
                    },
                    {
                        method: 'POST',
                        path: '/servicePrincipals/{id}/appRoleAssignedTo',
                        description: 'Grant app role assignment',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/serviceprincipal-post-approleassignedto'
                    },
                    {
                        method: 'DELETE',
                        path: '/servicePrincipals/{id}/appRoleAssignedTo/{appRoleAssignmentId}',
                        description: 'Remove app role assignment',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/serviceprincipal-delete-approleassignedto'
                    }
                ]
            },
            domains: {
                ...
                endpoints: [
                    ...
                    },
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/graph/api/domain-get'
                    },
                    {
                        method: 'POST',
                        path: '/domains/{id}/verify',
                        description: 'Verify domain',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/domain-verify'
                    }
                ]
            }
        }
            ...
            managedDevices: {
                ...
                endpoints: [
                    ...
                    },
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-devices-manageddevice-get'
                    },
                    {
                        method: 'POST',
                        path: '/deviceManagement/managedDevices/{id}/wipe',
                        description: 'Wipe device',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-devices-manageddevice-wipe'
                    },
                    {
                        method: 'POST',
                        path: '/deviceManagement/managedDevices/{id}/retire',
                        description: 'Retire device',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-devices-manageddevice-retire'
                    },
                    {
                        method: 'POST',
                        path: '/deviceManagement/managedDevices/{id}/resetPasscode',
                        description: 'Reset passcode',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-devices-manageddevice-resetpasscode'
                    },
                    {
                        method: 'POST',
                        path: '/deviceManagement/managedDevices/{id}/syncDevice',
                        description: 'Sync device',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-devices-manageddevice-syncdevice'
                    }
                ]
            },
                ...
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-devicecompliancepolicy-list'
                    },
                    {
                        method: 'GET',
                        path: '/deviceManagement/deviceCompliancePolicies/{id}',
                        description: 'Get compliance policy',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-devicecompliancepolicy-get'
                    },
                    {
                        method: 'POST',
                        path: '/deviceManagement/deviceCompliancePolicies',
                        description: 'Create compliance policy',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-devicecompliancepolicy-create'
                    },
                    {
                        method: 'PATCH',
                        path: '/deviceManagement/deviceCompliancePolicies/{id}',
                        description: 'Update compliance policy',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-devicecompliancepolicy-update'
                    },
                    {
                        method: 'DELETE',
                        path: '/deviceManagement/deviceCompliancePolicies/{id}',
                        description: 'Delete compliance policy',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-devicecompliancepolicy-delete'
                    }
                ]
            },
                ...
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-deviceconfiguration-list'
                    },
                    {
                        method: 'GET',
                        path: '/deviceManagement/deviceConfigurations/{id}',
                        description: 'Get device configuration',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-deviceconfiguration-get'
                    },
                    {
                        method: 'POST',
                        path: '/deviceManagement/deviceConfigurations',
                        description: 'Create device configuration',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-deviceconfiguration-create'
                    },
                    {
                        method: 'PATCH',
                        path: '/deviceManagement/deviceConfigurations/{id}',
                        description: 'Update device configuration',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-deviceconfiguration-update'
                    },
                    {
                        method: 'DELETE',
                        path: '/deviceManagement/deviceConfigurations/{id}',
                        description: 'Delete device configuration',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-deviceconfig-deviceconfiguration-delete'
                    }
                ]
            },
            mobileApps: {
                ...
                endpoints: [
                    {
                        ...
                        description: 'List mobile apps',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-apps-mobileapp-list'
                    },
                    {
                        method: 'GET',
                        path: '/deviceAppManagement/mobileApps/{id}',
                        description: 'Get mobile app',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-apps-mobileapp-get'
                    },
                    {
                        method: 'POST',
                        path: '/deviceAppManagement/mobileApps',
                        description: 'Create mobile app',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-apps-mobileapp-create'
                    }
                ]
            },
                ...
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-mam-managedapppolicy-list'
                    },
                    {
                        method: 'GET',
                        path: '/deviceAppManagement/androidManagedAppProtections',
                        description: 'List Android app protections',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-mam-androidmanagedappprotection-list'
                    },
                    {
                        method: 'GET',
                        path: '/deviceAppManagement/iosManagedAppProtections',
                        description: 'List iOS app protections',
                        docs: 'https://learn.microsoft.com/en-us/graph/api/intune-mam-iosmanagedappprotection-list'
                    }
                ]
            }
        }
    ...
    defender: {
        ...
        authScope: 'https://api.securitycenter.microsoft.com/.default',
        categories: {
            alerts: {
                name: 'Alerts',
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-alerts'
                    },
                    {
                        method: 'GET',
                        path: '/alerts/{id}',
                        description: 'Get alert by ID',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-alert-info-by-id'
                    },
                    {
                        method: 'PATCH',
                        path: '/alerts/{id}',
                        description: 'Update alert',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/update-alert'
                    },
                    {
                        method: 'POST',
                        path: '/alerts/createAlertByReference',
                        description: 'Create alert by reference',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/create-alert-by-reference'
                    }
                ]
            },
            incidents: {
                ...
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-incidents'
                    },
                    {
                        method: 'GET',
                        path: '/incidents/{id}',
                        description: 'Get incident by ID',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-incident-by-id'
                    },
                    {
                        method: 'PATCH',
                        path: '/incidents/{id}',
                        description: 'Update incident',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/update-incident'
                    }
                ]
            },
            machines: {
                ...
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-machines'
                    },
                    {
                        method: 'GET',
                        path: '/machines/{id}',
                        description: 'Get machine by ID',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-machine-by-id'
                    },
                    {
                        method: 'GET',
                        path: '/machines/{id}/alerts',
                        description: 'Get machine alerts',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-machine-related-alerts'
                    },
                    {
                        method: 'GET',
                        path: '/machines/{id}/vulnerabilities',
                        description: 'Get machine vulnerabilities',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-discovered-vulnerabilities'
                    },
                    {
                        method: 'POST',
                    ...
                    {
                        method: 'POST',
                        path: '/machines/{id}/runAntiVirusScan',
                        description: 'Run antivirus scan',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/run-av-scan'
                    }
                ]
            },
            vulnerabilities: {
                ...
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-all-vulnerabilities'
                    },
                    {
                        method: 'GET',
                        path: '/vulnerabilities/{id}',
                        description: 'Get vulnerability by ID',
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-vulnerability-by-id'
                    }
                ]
            },
            indicators: {
                ...
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-ti-indicators-collection'
                    },
                    {
                        method: 'POST',
                        path: '/indicators',
                    ...
                    },
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/update-ti-indicator'
                    },
                    {
                        method: 'DELETE',
                        path: '/indicators/{id}',
                ...
                endpoints: [
                    {
                        ...
                        docs: 'https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/run-advanced-query-api'
                    }
                ]
            }
        }
